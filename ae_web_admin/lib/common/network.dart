...
class Network {
  ...
  static String _apiEndpoint({_ApiEndpoint apiEndpoint}) {
    ...
    if (apiEndpoint == _ApiEndpoint.Development) {
      return 'https://api.dev.aa.com'; // Do NOT include a trailing forward slash!
  ...
  static Future<NetworkResult> delete({
    ...
    try {
      ...
      await http
          .delete(
        '${stringUrl ?? _stringActiveEndpoint}/$stringPath/$stringId',
  ...
  /// Send the POST request to the API
  static Future<NetworkResult> postFormData({
    String stringUrl,
    @required String stringPath,
    @required Map<String, String> mapPayloadBody,
    @required Map<String, String> mapPayloadHeader,
  }) async {
    NetworkResult _networkResult = NetworkResult();
