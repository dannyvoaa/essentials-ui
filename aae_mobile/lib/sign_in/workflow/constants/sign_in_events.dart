...
class SignInEvents {
  ...
  static WorkflowEvent get validationSucceeded =>
      WorkflowEvent('ProfileValidationSucceeded');

  static WorkflowEvent get profileCreationSucceeded =>
      WorkflowEvent('ProfileCreationSucceeded');

  static WorkflowEvent get silentSignInFailed =>
      WorkflowEvent('SilentSignInFailed');

  static WorkflowEvent get authFlowFailed => WorkflowEvent('AuthFlowFailed');

  static WorkflowEvent get profileCreationFailed =>
      WorkflowEvent('ProfileCreationFailed');
