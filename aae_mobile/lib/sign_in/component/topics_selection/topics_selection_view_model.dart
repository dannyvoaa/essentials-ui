...
///
abstract class TopicsSelectionViewModel implements Built<TopicsSelectionViewModel, TopicsSelectionViewModelBuilder> {
  ...
  factory TopicsSelectionViewModel({@required BuiltList<TopicsViewModel> topics, @required bool nextButtonEnabled}) = _$TopicsSelectionViewModel._;
}
...
abstract class TopicsViewModel implements Built<TopicsViewModel, TopicsViewModelBuilder> {
  ...
  TopicsViewModel._();
  factory TopicsViewModel({@required String topic, @required AaeCommand onTopicPressed, @required bool isSelected,}) = _$TopicsViewModel._;
}
