...
///
abstract class HubLocationsSelectionViewModel implements Built<HubLocationsSelectionViewModel, HubLocationsSelectionViewModelBuilder> {
  ...
  factory HubLocationsSelectionViewModel({@required BuiltList<HubLocationsViewModel> hubLocations, @required bool nextButtonEnabled}) = _$HubLocationsSelectionViewModel._;
}
...
abstract class HubLocationsViewModel implements Built<HubLocationsViewModel, HubLocationsViewModelBuilder> {
  ...
  factory HubLocationsViewModel({@required String hubLocation, @required AaeCommand onHubLocationPressed, @required bool isSelected}) = _$HubLocationsViewModel._;
}
