...
/// Returns a [OperatorFunction] which accumulates the [source] Observable with
/// [operand] Observable and [accumulator].
...
/// to the previously emitted value using [accumulator] to produce the next
/// emission.
/// [operand] is only subscribed to after the first emission of [source].
/// # Example
/// src: -----------------2|------------------------------------
/// op : -------------1--------3--------5--------7------9--|----
/// [          src.accumulateWith(op, (x, y) => x + y)         ]
/// out: -----------------2----5--------10-------17-----26-|----
