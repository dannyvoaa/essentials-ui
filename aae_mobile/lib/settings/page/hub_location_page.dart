...
import 'package:aae/settings/settingslist/hub_location_list_component.dart';
...
class HubLocationPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: HubLocationListComponent(),
    );
  }
}

class HubLocationPageProvider implements PageProvider {
  @override
  WidgetBuilder providePageBuilder(BuildContext context) {
    return (context) => HubLocationPage();
  }
}
