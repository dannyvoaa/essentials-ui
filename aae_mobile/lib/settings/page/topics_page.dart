...
import 'package:aae/settings/settingslist/topics_list_component.dart';
...
class TopicsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: TopicsListComponent(),
    );
  }
}

class TopicsPageProvider implements PageProvider {
  @override
  WidgetBuilder providePageBuilder(BuildContext context) {
    return (context) => TopicsPage();
  }
}
