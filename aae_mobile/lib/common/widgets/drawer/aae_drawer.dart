  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        ...
        children: <Widget>[
          Container(child: Text("Privacy policy\n", style: TextStyle(color: AaeColors.darkGray,fontWeight:FontWeight.bold, fontSize:20), ), ),
          ...
          Row(
            ...
            children: [
              SizedBox(width: 10),
              Text('\u25AA',style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),),
              SizedBox(width: 8),
              Expanded(child: Text('Contact and personal information - including name, gender, ethnicity (if volunteered or where necessary to comply with legal obligations, such as for diversity purposes), nationality/citizenship, home address and telephone number and other contact details, date of birth, disability status, marital status and dependents, emergency contacts;\n', style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),), ),
            ],
          ),
          ...
          Row(
            ...
            children: [
              ...
              Text('\u25AA',style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),),
              SizedBox(width: 8),
              Expanded(child: Text('Financial information - taxpayer identification number(s) such as a social security number, banking details including credit and debit card information;\n', style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),), ),
            ],
          ),
          ...
          Row(
            ...
            children: [
              ...
              Text('\u25AA',style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),),
              SizedBox(width: 8),
              Expanded(child: Text('Benefits distribution information - sick pay, pensions, insurance and other incentives and benefits information (including the gender, age, marital status, nationality and passport information for any spouse, guest travelers, minor children or other eligible dependents and beneficiaries);\n', style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),), ),
            ],
          ),
          ...
          Row(
            ...
            children: [
              ...
              Text('\u25AA',style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),),
              SizedBox(width: 8),
              Expanded(child: Text('Career and job performance information - employee ID number, job title, job grade and function, date of hire, date(s) of promotions(s), work history, hours worked, work location, direct manager/supervisor information, technical skills, educational background, professional certifications and registrations, language capabilities, training courses attended and training assessment, records of work absences, vacation entitlement and requests, salary information (history and expectations), performance appraisals/evaluations, letters of appreciation and commendation, disciplinary and grievance procedures (including monitoring compliance with and enforcing American policies), employee complaints;\n', style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),), ),
            ],
          ),
          ...
          Row(
            ...
            children: [
              ...
              Text('\u25AA',style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),),
              SizedBox(width: 8),
              Expanded(child: Text('Health-related information - height, weight, clothing sizes, photographs, symptoms, physical limitations and special needs;\n', style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),), ),
            ],
          ),
          ...
          Row(
            ...
            children: [
              ...
              Text('\u25AA',style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),),
              SizedBox(width: 8),
              Expanded(child: Text('Compliance information as required to comply with laws, including the requests and directions of law enforcement authorities or court orders (child support and debt payment information) and acknowledgements regarding American policies; and\n', style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),), ),
            ],
          ),
          ...
          Row(
            ...
            children: [
              ...
              Text('\u25AA',style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),),
              SizedBox(width: 8),
              Expanded(child: Text('Automatically collected information – information captured on security systems, including CCTV and key card entry systems, video recordings of company events and activities, voicemails, e-mails, correspondence and other work product and communications created, stored or transmitted by an employee using American’s computer or communications equipment, use of American’s computer equipment and company issued mobile devices, including Internet browsing history, mobile app usage, and precise geo-location.\n', style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),), ),
            ],
          ),
          ...
          Row(
            ...
            children: [
              ...
              Text('\u25AA',style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),),
              SizedBox(width: 8),
              Expanded(child: Text('Where we need to in order to carry out our legal obligations;\n', style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),), ),
            ],
          ),
          ...
          Row(
            ...
            children: [
              ...
              Text('\u25AA',style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),),
              SizedBox(width: 8),
              Expanded(child: Text('Where it is needed in the public interest, such as for equal opportunities monitoring or in relation to our occupational pension scheme; or\n', style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),), ),
            ],
          ),
          ...
          Row(
            ...
            children: [
              ...
              Text('\u25AA',style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),),
              SizedBox(width: 8),
              Expanded(child: Text('Where it is needed to assess your working capacity on health grounds, subject to appropriate confidentiality safeguards.\n', style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),), ),
            ],
          ),

          Container(child: Text('We may use this type of data, where it is necessary in relation to legal claims, where it is necessary to protect your interests (or someone else’s) and where you are not capable of giving consent, or where you have already made the information public.\n\nWe will also use sensitive personal data to carry out our obligations in connection with your employment as set out below:\n', style: TextStyle(color: AaeColors.lightGray, fontSize:16, height:1.3), ), ),
          ...
          Row(
            ...
            children: [
              ...
              Text('\u25AA',style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),),
              SizedBox(width: 8),
              Expanded(child: Text('Information relating to leaves of absence, which may include sickness absence or family related leaves, to comply with employment and other laws;\n', style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),), ),
            ],
          ),
          ...
          Row(
            ...
            children: [
              ...
              Text('\u25AA',style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),),
              SizedBox(width: 8),
              Expanded(child: Text('Information about your physical or mental health or disability status, to ensure your health and safety in the workplace and to assess your fitness to work, to provide appropriate workplace adjustments, to monitor and manage sickness absence and to administer benefits;\n', style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),), ),
            ],
          ),
          ...
          Row(
            ...
            children: [
              ...
              Text('\u25AA',style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),),
              SizedBox(width: 8),
              Expanded(child: Text('Information about your race or national or ethnic origin, religious, philosophical or moral beliefs, or your sex life or sexual orientation, to ensure meaningful equal opportunity monitoring and reporting;\n', style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),), ),
            ],
          ),
          ...
          Row(
            ...
            children: [
              ...
              Text('\u25AA',style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),),
              SizedBox(width: 8),
              Expanded(child: Text('Trade union membership information to pay trade union premiums, register the status of a protected employee and to comply with employment law obligations.\n', style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),), ),
            ],
          ),
          ...
          Row(
            ...
            children: [
              ...
              Text('\u25AA',style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),),
              SizedBox(width: 8),
              Expanded(child: Text('Facilitate internal applications: evaluate applications for employment opportunities within American*** - visa status/right to work in the jurisdiction** and background checks, where appropriate***;\n', style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),), ),
            ],
          ),
          ...
          Row(
            ...
            children: [
              ...
              Text('\u25AA',style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),),
              SizedBox(width: 8),
              Expanded(child: Text('Internal employee management: manage all aspects of an employee’s employment relationship - including without limitation payroll, benefits, incentives, compensation, corporate travel and other reimbursable expenses, development and training, absence monitoring, timekeeping, performance appraisal, disciplinary and grievance processes, administration of termination of employment, resource planning and allocation, talent management, succession planning and other general administrative and human resource related processes*;\n', style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),), ),
            ],
          ),
          ...
          Row(
            ...
            children: [
              ...
              Text('\u25AA',style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),),
              SizedBox(width: 8),
              Expanded(child: Text('Career planning: resource planning and allocation, talent management, succession planning***;\n', style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),), ),
            ],
          ),
          ...
          Row(
            ...
            children: [
              ...
              Text('\u25AA',style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),),
              SizedBox(width: 8),
              Expanded(child: Text('Business travel, relocation, transfers and cross-border programs: coordinate global employee programs, international moves and cross-border team work and project management*;\n', style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),), ),
            ],
          ),
          ...
          Row(
            ...
            children: [
              ...
              Text('\u25AA',style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),),
              SizedBox(width: 8),
              Expanded(child: Text('Compensation and benefits management: coordinate compensation and maintain medical and sickness records and occupational health programs - emergency contact and beneficiary details (which involves American holding information of those you nominate in this respect)*;\n', style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),), ),
            ],
          ),
          ...
          Row(
            ...
            children: [
              ...
              Text('\u25AA',style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),),
              SizedBox(width: 8),
              Expanded(child: Text('Corporate communications: to communicate with internal and external audiences (e.g., conduct employee surveys, administer employee recognition programs and promotions and diversity programs)*; and\n', style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),), ),
            ],
          ),
          ...
          Row(
            ...
            children: [
              ...
              Text('\u25AA',style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),),
              SizedBox(width: 8),
              Expanded(child: Text('Compliance requirements: comply with applicable laws (e.g., health and safety), including judicial or administrative orders regarding individual employees (e.g., garnishments, child support payments)**.\n', style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),), ),
            ],
          ),


          Container(child: Text('Some of the grounds for processing will overlap and there may be several grounds which justify our use of your personal information.\n\nThere are Closed Circuit Television (CCTV) cameras in operation within and around our stations and other premises, which are used for the following purposes:\n', style: TextStyle(color: AaeColors.lightGray, fontSize:16, height:1.3), ), ),
          ...
          Row(
            ...
            children: [
              ...
              Text('\u25AA',style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),),
              SizedBox(width: 8),
              Expanded(child: Text('to prevent and detect crime**;\n', style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),), ),
            ],
          ),
          ...
          Row(
            ...
            children: [
              ...
              Text('\u25AA',style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),),
              SizedBox(width: 8),
              Expanded(child: Text('to protect the health and safety of American customers and employees**;\n', style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),), ),
            ],
          ),
          ...
          Row(
            ...
            children: [
              ...
              Text('\u25AA',style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),),
              SizedBox(width: 8),
              Expanded(child: Text(' to manage and protect American’s property and the property of American’s guests and other visitors***; and\n', style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),), ),
            ],
          ),
          ...
          Row(
            ...
            children: [
              ...
              Text('\u25AA',style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),),
              SizedBox(width: 8),
              Expanded(child: Text('for quality assurance purposes***.\n', style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),), ),
            ],
          ),
          ...
          Row(
            ...
            children: [
              ...
              Text('\u25AA',style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),),
              SizedBox(width: 8),
              Expanded(child: Text('In order to carry out the purposes set forth above, your information will be disclosed to the appropriate personnel within American, including without limitation human resources and payroll/accounting staff, and managers as well as American’s affiliates, consultants and other advisers or persons when necessary.  This includes disclosure of personal information to or for:\n', style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),), ),
            ],
          ),
          ...
          Row(
            ...
            children: [
              ...
              Text('\u25AA',style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),),
              SizedBox(width: 8),
              Expanded(child: Text('When we outsource the processing of your personal information to third parties or provide your personal information to third party service providers, we take reasonable measures, such as implementing contractual controls, to endeavor to provide that those third parties safeguard your personal information with appropriate security measures and prohibit them from using your personal information for their own purposes or from disclosing your personal information to other third parties.\n', style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),), ),
            ],
          ),
          ...
          Row(
            ...
            children: [
              ...
              Text('\u25AA',style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),),
              SizedBox(width: 8),
              Expanded(child: Text('Legal and Regulatory Requirements: To the extent required by relevant, applicable law or regulation, we may be obligated to disclose personal information to government authorities, or to third parties pursuant to a subpoena or other legal process.**  Such information may be disclosed to:\n', style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),), ),
            ],
          ),
          ...
          Row(
            ...
            children: [
              ...
              Text('\u25AB',style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),),
              SizedBox(width: 8),
              Expanded(child: Text('Protect your or American’s legal claims and interests\n', style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),), ),
            ],
          ),
          ...
          Row(
            ...
            children: [
              ...
              Text('\u25AB',style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),),
              SizedBox(width: 8),
              Expanded(child: Text('Defend against potential or actual litigation\n', style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),), ),
            ],
          ),
          ...
          Row(
            ...
            children: [
              ...
              Text('\u25AB',style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),),
              SizedBox(width: 8),
              Expanded(child: Text('Abide by applicable law, regulation or contracts\n', style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),), ),
            ],
          ),
          ...
          Row(
            ...
            children: [
              ...
              Text('\u25AB',style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),),
              SizedBox(width: 8),
              Expanded(child: Text('Respond to a court order, governmental administrative or judicial process, including but not limited to, a subpoena or search warrant\n', style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),), ),
            ],
          ),
          ...
          Row(
            ...
            children: [
              ...
              Text('\u25AB',style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),),
              SizedBox(width: 8),
              Expanded(child: Text('Comply with American’s obligations where it is registered with any governmental agency\n', style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),), ),
            ],
          ),
          ...
          Container(child: Text("Your Rights with Respect to Your Personal Information\n", style: TextStyle(color: AaeColors.lightGray,fontWeight:FontWeight.bold, fontSize:18,height:1.3), ), ),
          Container(child: Text("Right to Object\n", style: TextStyle(color: AaeColors.lightGray,fontWeight:FontWeight.bold, fontSize:16,height:1), ), ),
          ...
          Row(
            ...
            children: [
              ...
              Text('\u25AA',style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),),
              SizedBox(width: 8),
              Expanded(child: Text('Request access to your personal information. This enables you to receive a copy of the personal information we hold about you and to check that we are lawfully processing it.\n', style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),), ),
            ],
          ),
          ...
          Row(
            ...
            children: [
              ...
              Text('\u25AA',style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),),
              SizedBox(width: 8),
              Expanded(child: Text('Request correction of the personal information that we hold about you. This enables you to have any incomplete or inaccurate information we hold about you corrected.\n', style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),), ),
            ],
          ),
          ...
          Row(
            ...
            children: [
              ...
              Text('\u25AA',style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),),
              SizedBox(width: 8),
              Expanded(child: Text('Request erasure of your personal information. This enables you to ask us to delete or remove personal information where there is no good reason for us continuing to process it. You also have the right to ask us to delete or remove your personal information where you have exercised your right to object to processing (see above).\n', style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),), ),
            ],
          ),
          ...
          Row(
            ...
            children: [
              ...
              Text('\u25AA',style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),),
              SizedBox(width: 8),
              Expanded(child: Text('Request the restriction of processing of your personal information. This enables you to ask us to suspend the processing of personal information about you, for example if you want us to establish its accuracy or the reason for processing it;\n', style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),), ),
            ],
          ),
          ...
          Row(
            ...
            children: [
              ...
              Text('\u25AA',style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),),
              SizedBox(width: 8),
              Expanded(child: Text('Request the transfer of your personal information to another party; and\n', style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),), ),
            ],
          ),
          ...
          Row(
            ...
            children: [
              ...
              Text('\u25AA',style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),),
              SizedBox(width: 8),
              Expanded(child: Text('The right to withdraw consent at any time where we have relied on it to process your personal data.\n', style: TextStyle(color: AaeColors.lightGray, fontSize:16,height:1.3),), ),
            ],
          ),

          Container(child: Text('Similar rights may exist under local data protection laws of other countries outside of the EU and the US. For further details please use the contact details below.\n', style: TextStyle(color: AaeColors.lightGray, fontSize:16, height:1.3), ), ),
