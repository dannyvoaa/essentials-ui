    ...
    return Scaffold(
      ...
      body: ListView(
                     padding: EdgeInsets.only(left:30,top:40,right:30),
                                ...
                                Container(child: Text("Your Rights with Respect to Your Personal Information\n", style: TextStyle(color: AaeColors.lightGray,fontWeight:FontWeight.bold, fontSize:16,height:1.3), ), ),
                                Container(child: Text("Right to Object\n", style: TextStyle(color: AaeColors.lightGray,fontWeight:FontWeight.bold, fontSize:15,height:1), ), ),
