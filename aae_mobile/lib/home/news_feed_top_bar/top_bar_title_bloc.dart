...
class TopBarTitleBloc {
  static final _log = Logger('TopBarTitleBloc');
  final SignInRepository _signInRepository;

  Source<TopBarTitleViewModel> get viewModel => toSource(combineLatest(Observable.fromFuture(_signInRepository.identity), _createViewModel));
