...
class _ReplaySubject<T> extends _Subject<T> {
  ...
  _ReplaySubject(
      ...
      : _cachedValues = DoubleLinkedQueue.from(initValues),
        super() {
    checkState(_shouldReplayAll || _bufferSize >= 1,
        message: 'Replay subject will either replay all elements '
            'or replay positive bufferSize of elements, '
            'but the bufferSize is $_bufferSize');
    name =
